...
q1_template:  """
	...
	sum({{.schema.lineitem.extendedprice}}*(1-{{.schema.lineitem.discount}})) as sum_disc_price,
	sum({{.schema.lineitem.extendedprice}}*(1-{{.schema.lineitem.discount}})*(1+{{.schema.lineitem.tax}})) as sum_charge,
